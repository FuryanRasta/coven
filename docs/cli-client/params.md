...
```bash
coven query params subspace [subspace] [key] [flags]
```
...
| `MintDenom` | Denom of the token mintable | ucoven   |
...
| key             | description                                      | default                                                         |
| --------------- | ------------------------------------------------ | --------------------------------------------------------------- |
| `depositparams` | Related parameters of the deposit mortgage phase | `min_deposit`:    10000000ucoven; `max_deposit_period`: 2d(days) |
...
| key           | description  | default   |
| ------------- | ------------ | --------- |
| `ConstantFee` | Constant Fee | 1000ucoven |
...
| `IssueTokenBaseFee` | Base token for issuing tokens     | 60000 * 10^6 ucoven |
...
| key             | description                   | default |
| --------------- | ----------------------------- | ------- |
| `StandardDenom` | The name of the token charged | ucoven   |
...
| `AssetParam.DeputyAddress` | Deputy's COVENhub address          | “iaa18n3x722r4jpwmshlxnw3ehlpfzywupzefthcz5” |
...
| `MinDeposit`                | Minimum deposit amount                              | 6000ucoven  |
...
| `BaseDenom`                 | Tokens supported by service fees                    | ucoven      |
