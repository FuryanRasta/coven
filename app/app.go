...
import (
	...
	"github.com/mage-war/coven/address"
	covenante "github.com/mage-war/coven/ante"
	covenappparams "github.com/mage-war/coven/app/params"
	"github.com/mage-war/coven/lite"
	"github.com/mage-war/coven/modules/guardian"
	guardiankeeper "github.com/mage-war/coven/modules/guardian/keeper"
	guardiantypes "github.com/mage-war/coven/modules/guardian/types"
	"github.com/mage-war/coven/modules/mint"
	mintkeeper "github.com/mage-war/coven/modules/mint/keeper"
...
var (
	_ simapp.App              = (*CovenApp)(nil)
	_ servertypes.Application = (*CovenApp)(nil)
)

// CovenApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type CovenApp struct {
	*baseapp.BaseApp
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".coven")
...
// NewCovenApp returns a reference to an initialized CovenApp.
func NewCovenApp(
	logger log.Logger,
	db dbm.DB,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig covenappparams.EncodingConfig,
	...
	anteHandler, err := covenante.NewAnteHandler(
		covenante.HandlerOptions{
...
func (app *CovenApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *CovenApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *CovenApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *CovenApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *CovenApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *CovenApp) ModuleAccountAddrs() map[string]bool {
...
// addresses.
func (app *CovenApp) BlockedModuleAccountAddrs() map[string]bool {
...
func (app *CovenApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns CovenApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *CovenApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns CovenApp's InterfaceRegistry
func (app *CovenApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *CovenApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *CovenApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *CovenApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *CovenApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *CovenApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided API server.
func (app *CovenApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *CovenApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *CovenApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *CovenApp) RegisterUpgradeHandler(
	planName string,
